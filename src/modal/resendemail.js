...
const ResendEmail = (props) => {
    ...
    var emailInput = document.querySelector('#emailRe')
    ...
    const onclickResendEmail = async () => {
        const result = await userApi.ResendEmail(email)
    ...
    return (
        <div className="loginbox" style={props.LoginStyle}>
            ...
            <div className='box'>
                <h1>Email</h1>
                <p>input your email to active Account</p>
                <input id="emailRe" type="email" placeholder="email" onChange={(e) => setEmail(e.target.value)}></input>
